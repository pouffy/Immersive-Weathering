...
public class MossyStairsBlock extends ModStairBlock implements IMossy, BonemealableBlock {

    public MossyStairsBlock(Supplier<Block> state, Properties properties) {
