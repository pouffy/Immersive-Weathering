...
public class ModTags {
    ...
    //items
    public static final TagKey<Item> BARK = registerItemTag("bark", "Bark");
    public static final TagKey<Item> SCALES = registerItemTag("scales", "Scales");
    public static final TagKey<Item> STRIPPED_WOOD = registerItemTag("stripped_wood", "Stripped Wood");
    ...
    static TagKey<Block> registerBlockTag(String id) {
        return TagKey.create(Registries.BLOCK, ImmersiveWeathering.res(id));
    }

    private static TagKey<Item> registerItemTag(String id, String engTranslation) {
        var tag = TagKey.create(Registries.ITEM, ImmersiveWeathering.res(id));
        ITEM_TAGS.add(new Pair<>(tag, engTranslation));
        return tag;
    }
