...
public class MossSpreader implements PatchSpreader {

    @Override
    public Holder<? extends PatchSpreader> getType() {
        return ModSpreaders.MOSS;
    }
    ...
    public static void growNeighbors(ServerLevel level, RandomSource random, BlockPos pos) {
