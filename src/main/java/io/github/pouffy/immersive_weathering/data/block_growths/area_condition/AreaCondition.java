package io.github.pouffy.immersive_weathering.data.block_growths.area_condition;
...
public interface AreaCondition {
    ...
    Codec<AreaCondition> CODEC = AreaConditionType.CODEC.dispatch("type", AreaCondition::getType, AreaConditionType::codec);
